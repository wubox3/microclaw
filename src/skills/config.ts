...
export function resolveConfigPath(config: EClawConfig | undefined, pathStr: string): unknown {
...
export function isConfigPathTruthy(config: EClawConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["eclaw-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(entry.skill.source);
}

export function resolveBundledAllowlist(config?: EClawConfig): string[] | undefined {
